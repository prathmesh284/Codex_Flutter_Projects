...
class InstagramUI extends StatelessWidget {
  ...
  final Icon icon;
  final int counter;
  final void changeFavoratesState; 
  const InstagramUI({super.key,required this.imgUrl,required this.name,required this.icon, required this.counter,this.changeFavoratesState});
...
class _Assignment2State extends State<Assignment3> {
  Icon iconFav=const Icon(Icons.favorite_border,color: Colors.white,);
  int counter=68;
  int max=69;
  bool changedIcon=false;
  void changeFavoratesState(){
    if(changedIcon){
      changedIcon=false;
      if(counter == max){
        counter--;
    ...
    iconFav=changedIcon?const Icon(Icons.favorite,color: Colors.red,):const Icon(Icons.favorite_border,color: Colors.white,);
    setState(() {});
  }
  @override
  Widget build(BuildContext context) {
          ...
          child: SingleChildScrollView(
            ...
            child:Column(
              ...
              InstagramUI(
                ...
                // ignore: void_checks
                changeFavoratesState: changeFavoratesState,
              )
